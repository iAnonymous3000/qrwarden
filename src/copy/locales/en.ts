...
export const EN_COPY = Object.freeze({
  ...
  shareBusyHeading: "Too many shared images.",
  shareBusyBody:
    "QRWarden is already handling four shared images. Return to the app you shared from and try this image again after the earlier shares finish.",
  ...
  pasteHint: "You can also paste or drop an image here.",
  signalNeedsReview: "Needs review",
  signalContext: "Context",
  copyReportButton: "Copy redacted report",
  ...
  actualDestination: "Address in the QR code",
  ...
  fieldLabels: Object.freeze({
    ...
    "Declared EAP method (not validated)": "Declared EAP method (not validated)",
    "Ends": "Ends",
    "Event": "Event",
    "Fragment": "Fragment",
    "Fragment names": "Fragment names",
    "Hexadecimal preview": "Hexadecimal preview",
    "Declared hidden network (not validated)": "Declared hidden network (not validated)",
    "Identity": "Identity",
    "Location": "Location",
  ...
  fieldValues: Object.freeze({
    ...
    "Yes": "Yes",
    "No": "No",
    "TOTP setup payload": "TOTP setup payload",
    "HOTP setup payload": "HOTP setup payload",
    ...
    "URI scheme recognized; payload not validated":
      "URI scheme recognized; payload not validated",
    "URI scheme only (no payload)": "URI scheme only (no payload)",
    "Localhost": "Localhost",
  ...
  kindLabels: Object.freeze<Record<PayloadKind, string>>({
    ...
    geo: "Location",
    payment: "Payment-scheme URI",
    "custom-uri": "Non-web URI",
    gs1: "GS1 data",
  ...
  signalGlossary: Object.freeze<Record<AnalysisSignalCode, SignalGlossaryCopy>>({
    ...
    "local-or-special-destination": {
      ...
      explanation:
        "The host or address is in a local or special-purpose category. That can mean local, private, documentation-only, multicast, reserved, or a globally reachable exception; review the category shown above.",
    },
    "non-default-port": {
