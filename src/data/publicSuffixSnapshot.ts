...
export const PUBLIC_SUFFIX_SNAPSHOT = Object.freeze({
  ...
  icannRules: Object.freeze<string[]>([
    "0.bg",
    "1.bg",
    "2.bg",
    "2000.hu",
  ...
  privateRules: Object.freeze<string[]>([
    "0am.jp",
    "0g0.jp",
    "0j0.jp",
    "0t0.jp",
  ...
  wildcardRules: Object.freeze<string[]>([
    "ck",
    "er",
    "fk",
    "jm",
  ...
  privateWildcardRules: Object.freeze<string[]>([
  ...
  exceptionRules: Object.freeze<string[]>([
    "city.kawasaki.jp",
    "city.kitakyushu.jp",
    "city.kobe.jp",
    "city.nagoya.jp",
  ...
  privateExceptionRules: Object.freeze<string[]>([]),
});
